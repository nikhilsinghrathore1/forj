  ...
  return (
    <div className={`w-full flex flex-col  gap-5 mt-5 justify-center "`}>
      <div
        ...
        className={`${
          activeLink === "home"
            ? "flex transition-all duration-300 cursor-pointer  gap-[6px] f10 text-[#356772]  items-center"
            : "flex cursor-pointer opacity-70 gap-[6px] f10 text-[#162c31]  items-center"
        }`}
      >
        <svg
          aria-hidden="true"
      ...
      <div
        ...
        className={`${
          activeLink === "discover"
            ? "flex cursor-pointer transition-all duration-300  gap-[6px] f10 text-[#356772]  items-center"
            : "flex cursor-pointer opacity-70 gap-[6px] f10 text-[#162c31]  items-center"
        }`}
      >
        <svg
      ...
      <div
        ...
        className={`${
          activeLink === "library"
            ? "flex cursor-pointer transition-all duration-300  f10 text-[#356772] gap-[6px]  items-center"
            : "flex cursor-pointer opacity-70 gap-[6px] f10 text-[#162c31]  items-center"
        }`}
      >
        <svg
