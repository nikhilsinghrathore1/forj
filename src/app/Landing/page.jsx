...
import HoriCards from "./Components/HoriCards"
import LandingNavbar from './Components/LandingNavbar'
import ExpandedComp from './Components/ExpandedComp'
import VerticalExpand from './Components/VerticalExpand'
  ...
  return (
    ...
    {/* input div */}
      <div className='f18  w-full text-center text-[#515E5B] mt-10'>
          ...
          <div className='flex mt-10 mb-8 items-center justify-center w-full  gap-2'>
            ...
            <div className='px-5 w-[15%] bg-[#B0EC9C] flex items-center gap-2 justify-center f18 py-[16px] rounded-full border-[1px]   text-lg border-black '>
                                             Get started now
                                             <svg class="ButtonBrand_icon__mayHb" width="24" height="24" viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M11.47 4.47a.75.75 0 0 1 1.06 0l7 7a.75.75 0 0 1 0 1.06l-7 7a.75.75 0 1 1-1.06-1.06l5.72-5.72H5a.75.75 0 0 1 0-1.5h12.19l-5.72-5.72a.75.75 0 0 1 0-1.06Z"></path></svg>
            </div>
          </div>

          <p className='opacity-70'>By entering your email, you agree to receive emails from Buffer.</p>
      ...
      <div className='w-full h-[30vh] flex items-center gap-10 justify-center '>
            <HoriCards mainText={"182738"} subtext={"Actice users"}/>
            <HoriCards mainText={"7,858,881"} subtext={"Posts published last month"}/>
      ...
      <div className='w-full h-fit flex flex-col gap-4 pt-1 items-center justify-center'>
        ...
        <ExpandedComp img={"https://buffer.com/_next/image?url=%2Fstatic%2Fimages%2Fhomepage%2Fpublish-large.webp&w=1920&q=75"} heading={"publish"} mainText={'The most complete set of publishing integrations, ever'} mainPara={'Schedule your content to the most popular platforms including Facebook, Instagram, TikTok, LinkedIn, Threads, Bluesky, YouTube Shorts, Pinterest, Google Business, Mastodon and X.'} para1={"  Auto-publish your content or get a notification when it's time to post"} para2={"   Magically customize and repurpose your post for each platform"} para3={" See everything you have scheduled in a calendar or queue view"} alignment={false} bgColor={"#CFC2FF"}/>
        <ExpandedComp img={"https://buffer.com/_next/image?url=%2Fstatic%2Fimages%2Fhomepage%2Fcreate-large.webp&w=1920&q=75"} heading={"Create"} mainText={'Turn any idea into the perfect post'} mainPara={'Schedule your content to the most popular platforms including Facebook, Instagram, TikTok, LinkedIn, Threads, Bluesky, YouTube Shorts, Pinterest, Google Business, Mastodon and '} para1={"Auto-publish your content or get a"} para2={"Visually organize your ideas into groups or themes"} para3={"Add a beautiful link in bio page to your profiles"} alignment={true} bgColor={"#FFC4BD"}/>
      ...
      <div className='w-full h-fit flex gap-8 items-center justify-center mt-4'>
        ...
        <VerticalExpand heading={"collaborate"} mainHeading={"Great content, created together"} para={"Collaborate seamlessly with your team. Invite unlimited collaborators, assign roles and permissions, and keep everyone aligned with saved drafts and notes."} img={"https://buffer.com/_next/image?url=%2Fstatic%2Fimages%2Fhomepage%2Fcollaborate-large.webp&w=1920&q=75"}/>
        </div>
        <div className='w-[47%] h-[100vh] rounded-3xl flex flex-col  bg-[#B0EC9C]'>
        <VerticalExpand heading={"Engage"} mainHeading={"Reply to comments in a flash"} para={"Engage with your audience on Facebook and Instagram at 10x speed. Buffer will help you triage and respond to comments from one simple dashboard."} img={"https://buffer.com/_next/image?url=%2Fstatic%2Fimages%2Fhomepage%2Fengage-large.webp&w=1920&q=75"}/>
        </div>
      </div>
...
// so what am i doing today first let's complete this landing page  as soon as possible and then have to change the backend like i have to add the prompts in the backend part and have to update it as well kinda storing the example and maybe have to send the two three instances i have to create long work ig if it is simple page  
export default page