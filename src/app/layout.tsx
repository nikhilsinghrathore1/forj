      ...
      >
        ...
        <div className="h-full w-[14%] relative flex flex-col py-5 pl-5 pr-2 ">
          {/* logo */}
                  ...
                  <div className="w-full flex flex-col gap-5 mt-7 pl-2">
                    <div className="flex cursor-pointer gap-2 f10 text-[#162c31]  items-center">
                  ...
                  <h1>Home</h1>
                    ...
                    <div className="flex cursor-pointer opacity-70 gap-2 f10 text-[#162c31]  items-center">
                  ...
                  <h1>Discover</h1>
                    ...
                    <div className="flex gap-2 cursor-pointer opacity-70 f10 text-[#162c31]  items-center">
