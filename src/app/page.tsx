...
export default function Home() {
  ...
  {/* input div */}
    <div className='f18  w-full text-center text-[#515E5B] mt-10'>
        <p className='text-lg'>Plan, create, and build products with the most flexible Arweave toolkit.</p>
        {/* input area */}
        ...
        <p className='opacity-70'>By entering your adderss, you agree to terms and services of ANON.</p>
    ...
    <div className='w-full h-[30vh] flex items-center gap-10 justify-center '>
          ...
          <HoriCards mainText={"7,858,881"} subtext={"products created last month"}/>
    ...
    <div className='w-full h-fit flex flex-col gap-4 pt-1 items-center justify-center'>
      ...
      <ExpandedComp img={"https://buffer.com/_next/image?url=%2Fstatic%2Fimages%2Fhomepage%2Fpublish-large.webp&w=1920&q=75"} heading={"Deploy"} mainText={'The most complete tool for Arweave integrations, ever'} mainPara={'Deploy innovative full stack Arweave code using anon an AI generator—on , Pinterest, Google Business, Mastodon and X.'} para1={"  Auto Deploy your product or get a notification when it's ready to deploy"} para2={"Magically customize and create your project for each use case"} para3={"See everything you have created in a permanet stored files on Arweave"} alignment={false} bgColor={"#CFC2FF"}/>
      <ExpandedComp img={"https://buffer.com/_next/image?url=%2Fstatic%2Fimages%2Fhomepage%2Fcreate-large.webp&w=1920&q=75"} heading={"Create Products"} mainText={'Turn any idea into the working Product '} mainPara={'Schedule Anon’s Arweave deployment pipeline to synchronized endpoints: Facebook, Instagram, TikTok, LinkedIn, Threads, Bluesky, YouTube Shorts, Pinterest, Google Business, Mastodon and X.'} para1={"Auto-Deploy your Project or get a"} para2={"Visually Check your ideas before de"} para3={"Add a beautiful link in bio page to your profiles"} alignment={true} bgColor={"#FFC4BD"}/>
    ...
    <div className='w-full h-fit flex gap-8 items-center justify-center mt-4'>
      ...
      <VerticalExpand heading={"Ai Generate Code"} mainHeading={"Great Products, created together"} para={"   with saved drafts and notes."} img={"https://buffer.com/_next/image?url=%2Fstatic%2Fimages%2Fhomepage%2Fcollaborate-large.webp&w=1920&q=75"}/>
      </div>
      <div className='w-[47%] h-[100vh] rounded-3xl flex flex-col  bg-[#B0EC9C]'>
      <VerticalExpand heading={"Engage"} mainHeading={"build  a working prototype in minutes"} para={"Engage with your potential clients 10x faster by showcasing a working MVP. With Anon, you can generate interest from one simple workspace."} img={"https://buffer.com/_next/image?url=%2Fstatic%2Fimages%2Fhomepage%2Fengage-large.webp&w=1920&q=75"}/>
      </div>
    </div>
